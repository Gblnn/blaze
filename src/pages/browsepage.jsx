...
export default function BrowsePage(){
  ...
  let [toggle, setToggle] = useState(true)
    return(
        ...
        <BrowseHeader nav="false" click={()=>{toggle?setToggle(false):setToggle(true); toggle?setCategory('Phones'):setCategory('Laptops')}} text="Browse All" tag="" btn_text={category}/>
